...
function init(){
    ...
    var tokensJAnim = bodymovin.loadAnimation(tokensJ)
    console.log(gameJSONs.tokensToPlay);
    ...
    $.ajax({
        ...
        success: function( data ) {
           ...
           if (_userData.tokenBalance == 0){ 
            ...
            //$("p.points-container").text(_userData.tokenBalance)
            //$("p.tokens-container").text(_userData.pointBalance)
            ...
            var balanceTSAnim = bodymovin.loadAnimation(balanceTS)
    ...
    var flagAnim = bodymovin.loadAnimation(flag)
    flagAnim.play()
...
function setUpWinning(){
    ...
    i2 = 1;
    console.log("paso");
    gameJSONs.balance.layers[0].t.d.k[0].s.t = _tokensToPlay+"";
    gameJSONs.balance.layers[1].t.d.k[0].s.t = __tokensResponse.totalPoints+"";
    ...
    if (_tokensToPlay >= 1 && _tokensToPlay <= 99){
        ...
        gameJSONs.winningScreen.layers[4].t.d.k[0].s.t = __tokensResponse.totalPoints+""
         ...
         gameJSONs.winningScreen.layers[2].t.d.k[0].s.t = _tokensToPlay+""
    ...
    var knifeAnim = bodymovin.loadAnimation(knife)
    knifeAnim.play();
    ...
    var monkeyAnim = bodymovin.loadAnimation(monkey)
    monkeyAnim.play();
    ...
    var torchsAnim = bodymovin.loadAnimation(torchs)
    torchsAnim.play();
    ...
    var clownAnim = bodymovin.loadAnimation(clown)
    clownAnim.play();
    ...
    environment = {
        ...
        var environmentAnim = bodymovin.loadAnimation(environment)
    environmentAnim.play();
        ...
        var winningScreenAnim = bodymovin.loadAnimation(winningScreen)
    ...
    if (playID == 10){
        ...
        var celebration10Anim = bodymovin.loadAnimation(celebration10) 
...
function setupInitLayers(){
    console.log("paso a setupInitLayers()")
    var monkeyButton = {
    ...
    var monkeyButtonAnim = bodymovin.loadAnimation(monkeyButton);
